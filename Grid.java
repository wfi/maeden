...
//maedengraphics*/
{
	...
	/**
	 * sendAgentSensations: for each agent that is ready for it, send their sensory information in a JSON Array
	 * Entry0: smell direction to food
	 * Entry1: inventory in form ("inv-char")
	 * Entry2: visual array (as single string) in form ((row ("cell") ("cell"))(row ("cell")))
	 * Entry3: ground contents of agent position in form ("cont" "cont")
	 * Entry4: Agent's messages
	 * Entry5: Agent's energy
	 * Entry6: last action's result status (ok or fail)
	 * Entry7: world time
	 */
